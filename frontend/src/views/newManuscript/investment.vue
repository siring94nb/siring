<template>
  <div style="margin-top:100px;background:rgb(246,246,246);min-height:100vh">
    <Myheader />
    <div style="padding-top:10px;max-width:1260px;margin:0 auto">
            ...
            <el-tab-pane label="我要融资" name="second" :key="'second'">
              <div class="rongziBox">
                ...
                <div>
                  ...
                  <div class="miaoshu">例：APP用户数/微博用户数/微信用户数/其他平台合计用户数（如今日头条、一点资讯等新媒体分发平台，或各类直播平台等）；已有支付行为用户数；客单价；</div>
                ...
                <div>
                  ...
                  <div class="miaoshu">
                    支持ppt, pdf, doc, exl,等格式；最多上传1份方案；
                  </div>
                  <div>
                    <el-upload
                      class="upload-demo"
                ...
                <div class="yulanBox"><button>预览</button></div>
              </div>
            </el-tab-pane>
          </el-tabs>
        </div>
