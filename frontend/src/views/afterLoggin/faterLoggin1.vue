  ...
  <div>
    ...
    <div class="box" ref="box" :style="wstyle">
      <div class="imgBox">
        ...
        <div
          style="height: 2px; width: 160px;background: -webkit-linear-gradient(left,rgba(255, 255, 255, 0),rgb(197,150,142),rgba(255,255,255,0));background: linear-gradient(to right, rgba(255, 255, 255, 0),rgb(197,150,142),rgba(255,255,255,0));margin-bottom:6px"
        ></div>
        <div class="xxBox">
          <div>
            <span>￥{{yue}}</span>
