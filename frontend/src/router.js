...
export default new Router({
    routes: [{
        ...
        },
        {
            ...
            meta: { requireAuth: true }, //路由守卫开启标识
            component: () =>
                import ('@/views/tailorDemand/fillDemandNew'),
        },
        {
            path: "/newManuscriptC",
            name: "newManuscriptC",
            meta: { requireAuth: true }, //路由守卫开启标识
            component: () =>
                import ('@/views/newManuscript/newManuscriptC'),
        },
        {
            path: '/goods',
            name: 'goods',
        ...
        //登录后的路由
        {
            ...
            children: [{
                ...
                {
                    path: "/customization_analogy",
                    name: "customization_analogy",
                    meta: { requireAuth: true }, //路由守卫开启标识
                    props: true,
                    component: () =>
                        import ('@/views/afterLoggin/demand_order/customization_analogy'),
                },
                {
                    path: "/order_detail",
                    name: "order_detail",
