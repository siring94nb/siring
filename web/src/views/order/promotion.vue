  ...
  <div>
    ...
    <Card style="margin-bottom: 10px">
      <Row>
        ...
        <Col span="2">
          <Button type="primary" class="btns btn-xqqr">需求确认</Button>
        </Col>
        <Col span="2">
          <Button type="primary" class="btns btn-dxz">代写中</Button>
        </Col>
        <Col span="2">
          <Button type="primary" class="btns btn-qrgj">确认稿件</Button>
        </Col>
        <Col span="2">
          <Button type="primary" class="btns btn-ztz">智推中</Button>
        </Col>
        <Col span="2">
          <Button type="primary" class="btns btn-ztwc">智推完成</Button>
        </Col>
      </Row>
    </Card>
    <!-- <Modal
